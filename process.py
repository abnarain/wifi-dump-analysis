...
# mgmt processing of data 
	'''
	print "size of mgmt_contents[0],[1], [2],[3],[4], [5]", len(mgmt_contents[0]),len(mgmt_contents[1]),len(mgmt_contents[2]),len(mgmt_contents[3]),len(mgmt_contents[4]), len(mgmt_contents[5])
